...
import 'package:mealgro_rider_app/features/delivery_history/presentation/screens/delivery_history_screen.dart';
...
// Delivery screens
import 'package:mealgro_rider_app/features/delivery/presentation/screens/active_delivery_screen.dart';
import 'package:mealgro_rider_app/features/delivery/presentation/screens/delivery_success_screen.dart';
import 'package:mealgro_rider_app/features/delivery_history/presentation/screens/delivery_detail_screen.dart';
...
import 'package:mealgro_rider_app/features/withdrawals/presentation/screens/withdrawals_screen.dart';
import 'package:mealgro_rider_app/features/withdrawals/presentation/screens/withdrawal_confirm_screen.dart';
import 'package:mealgro_rider_app/features/withdrawals/presentation/screens/withdrawal_status_screen.dart';

// Bank account screens
import 'package:mealgro_rider_app/features/bank_account/presentation/screens/bank_account_screen.dart';
import 'package:mealgro_rider_app/features/bank_account/presentation/screens/add_bank_screen.dart';
import 'package:mealgro_rider_app/features/bank_account/presentation/screens/find_bank_screen.dart';

// Profile / settings screens
import 'package:mealgro_rider_app/features/profile/presentation/screens/account_settings/profile_settings_screen.dart';
import 'package:mealgro_rider_app/features/profile/presentation/screens/account_settings/change_picture_screen.dart';
import 'package:mealgro_rider_app/features/profile/presentation/screens/account_settings/change_email_screen.dart';
import 'package:mealgro_rider_app/features/profile/presentation/screens/account_settings/change_phone_screen.dart';
import 'package:mealgro_rider_app/features/settings/presentation/screens/app_settings_screen.dart';
...
final appRouterProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      // ── Auth ────────────────────────────────────────────────────────────
      GoRoute(
          path: RoutePaths.register, builder: (c, s) => const RegisterScreen(),),
      GoRoute(
      ...
      GoRoute(
          path: RoutePaths.addBank, builder: (c, s) => const AddBankScreen(),),
      GoRoute(
          path: RoutePaths.findBank, builder: (c, s) => const FindBankScreen(),),
      ...
      StatefulShellRoute.indexedStack(
        ...
        branches: [
          StatefulShellBranch(
            routes: [
              GoRoute(
                  path: RoutePaths.home, builder: (c, s) => const HomeScreen(),),
            ],
          ),
          StatefulShellBranch(
            routes: [
          ...
          StatefulShellBranch(
            routes: [
              GoRoute(
                  ...
                  builder: (c, s) => const DeliveryHistoryScreen(),),
            ],
          ),
          StatefulShellBranch(
            routes: [
